...
- fix: fix always-true conditional for `IS_MONOREPO_WITH_INDEPENDENT_VERSIONS` ([#145](https://github.com/MetaMask/action-publish-release/pull/145))
...
- Fix monorepo tag push when `persist-credentials` is false ([#141](https://github.com/MetaMask/action-publish-release/pull/141))
